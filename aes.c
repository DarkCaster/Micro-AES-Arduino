...
const uint8_t s_box[256] TARGET_FLASH_MEMORY = {
...
const uint8_t s_box_inverse[256] TARGET_FLASH_MEMORY = {
...
const uint8_t rcon[10] TARGET_FLASH_MEMORY = { 0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x40, 0x80, 0x1B, 0x36 };
